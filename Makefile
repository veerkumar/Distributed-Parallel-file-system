...
client_test: meta_data_manager_services.pb.o meta_data_manager_services.grpc.pb.o file_server_services.pb.o file_server_services.grpc.pb.o cache_manager.o pfs.o meta_data_manager_client.o client_test.o 
	$(CXX)  $^ $(LDFLAGS) -g -o $@
